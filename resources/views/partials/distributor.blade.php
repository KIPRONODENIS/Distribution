...
@endforeach
		...
		<tbody>
			<br>
			<tr>
		<div  class="alert alert-info w-75 mx-auto d-block">You haven't Recieved any Order Yet</div>
		</tr>
		</tbody>
		@endif
	</table>

<div class="mt-4 w-75 mx-auto border border-gray-100">
<h4 class="mt-4 mx-3"> PRODUCTS </h4>
			<table class="table-auto w-100 mx-auto mt-5">
...
@foreach($products as $product)
			<tr >
				...
				<td  class="flex justify-around">
					...
					<a href="{{route('product.delete',$product->id)}}" class="bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 m-2 rounded"><i class="fas fa-trash-alt"></i></a>
				</td>
			</tr>
@endforeach
