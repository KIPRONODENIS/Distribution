<div>
    {{-- Knowing others is intelligence; knowing yourself is true wisdom. --}}
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="quantity" wire:model="quantity" type="number" min="{{100}}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('quantity') border-red-500 @enderror" name="quantity" value="{{ old('quantity') }}" required autocomplete="quantity" placeholder="100">
